...
ActiveRecord::Schema.define(version: 20170821164021) do
  ...
  create_table "sede_queries", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "url"
    t.bigint "offense_type_id"
    t.datetime "last_fetch"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["offense_type_id"], name: "index_sede_queries_on_offense_type_id"
  end
